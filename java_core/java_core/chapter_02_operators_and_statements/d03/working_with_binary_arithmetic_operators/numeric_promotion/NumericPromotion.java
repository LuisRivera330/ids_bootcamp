package java_core.java_core.java_core.chapter_02_operators_and_statements.d03.working_with_binary_arithmetic_operators.numeric_promotion;
...
public class NumericPromotion {
    public static void main(String[] args) {
        ...
        long y = 33;
        long t = x * y;
        System.out.println(t); //Como long es más el resultado será long
        ...
        short x = 14; //Se convertirá automaticamente en int
